...
//  Word Scrabble
//
//  Created by Yash Poojary on 21/09/21.
//
//
...
struct ContentView: View {
    ...
    func addNewWord() {
        ...
        guard isOriginal(word: answer) else {
            wordError(title: "Word used already", message: "No")
            return
        }
        
        guard isPossible(word: answer) else {
            wordError(title: "Not recognised", message: "No")
            return
        }
        
        guard isReal(word: answer) else {
            wordError(title: "Not possible", message: "No")
            return
        }
        
        guard isNotRootWord(word: answer) else {
            wordError(title: "Root word not allowed!", message: "No")
            return
        }
...
//
//        guard isPossible(word: answer) else {
//            wordError(title: "Word not recognized", message: "You can't just make them you know")
//            return
//        }
//
//        guard isReal(word: answer) else {
